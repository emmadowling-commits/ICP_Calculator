...
high_intensity_categories = ["Construction", "Fleet & Vehicles", "Goods", "Logistics", "Materials"]

# If it's a physical category AND not specifically an "Indirect" material, use 60%
if any(cat in industry for cat in high_intensity_categories) and "Indirect" not in industry:
    spend_pct = 0.60  
else:
    spend_pct = 0.20  
